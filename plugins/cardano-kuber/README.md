...
`MESH_NETWORK_ID` from its process environment. Only the Plutus compiler requires the API
key. Runtime configuration belongs to the host; contract source and credentials are never
